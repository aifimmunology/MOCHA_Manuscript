...
pdf('/home/jupyter/MOCHA_Manuscript/SuppFig4_ZI_differentials/differentials_cutoff.pdf')
plot(mixture_model, density=T, breaks=200)
dev.off()

zeroes =rowMeans(tsam==0)

summary(zeroes[mean_intensities > 12])
summary(zeroes[mean_intensities < 12])
...
avg_zero = rowMeans(tmp==0)
avg_int = rowMeans(tmp)
...
pdf('/home/jupyter/MOCHA_Manuscript/SuppFig4_ZI_differentials/zeros_chr1.pdf')
...
png('/home/jupyter/MOCHA_Manuscript/SuppFig4_ZI_differentials/chr1_hm.png')
...
pdf('/home/jupyter/MOCHA_Manuscript/SuppFig4_ZI_differentials/zeros_bin.pdf')
