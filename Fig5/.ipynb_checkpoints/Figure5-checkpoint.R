...
allRows <-  rowAnnotation(
        "Group1 Without Zeros" = allBinary[,"Group1 Without Zeros"] <= 0.05,
        "Group1 With Zeros" = allBinary[,"Group1 With Zeros" ] <= 0.05,
        "Group2 Without Zeros" = allBinary[,"Group2 Without Zeros"] <= 0.05,
        "Group2 With Zeros" = allBinary[,"Group2 With Zeros"] <= 0.05,
        Type = allBinary$Type,
